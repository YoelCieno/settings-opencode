...
Debt categories (dead code, stale exports, config drift, duplicates, untracked files) are OUT OF SCOPE — route to /fix. You assess correctness/security/quality/tests only.
...
- `--docs` — Redirects to /update-docs (documentation review lives there)
