...
| Step | Action | File(s) |
|------|--------|---------|
| 1 | Define domain models | `core/models/<entity>.ts` |
| 2 | Define ports (abstract contracts) | `core/ports/<verb-noun>.port.ts` |
| 3 | Add business rules | `core/rules/<entity>.rules.ts` (if needed) |
